...
export default async function BlogPostPage({
  ...
  try {
    ...
    const post = await prisma.post.findUnique({
      where: { slug },
      include: {
        author: true, // Ensure 'author' relation is included
        categories: {
          include: {
            category: true, // Include the 'category' relation to access 'id' and 'name'
          },
        },
        comments: {
          include: {
            user: true, // Ensure 'user' relation is included for comments
          },
        },
      },
    });
