        ...
        <div className="container">
          ...
          <div className="max-w-md">
            <div className="relative">
              ...
              <input type="search" placeholder="Search categories..." className="w-full pl-10 h-10 rounded-md border border-input bg-background px-3 py-2 text-sm"/>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((category) => (<link_1.default key={category.id} href={`/blog?category=${category.slug}`} className="flex flex-col p-6 rounded-lg border bg-background hover:shadow-md transition-all">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button_1.Button variant="ghost" size="sm" className="font-medium">
                    Browse
                  </button_1.Button>
                </div>
              </link_1.default>))}
